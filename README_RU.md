...
**Стек:** C# / .NET 8 + WinForms. Один самодостаточный `.exe` — не требует установки Python или .NET.
...
5. xray-core (~15 МБ) скачается с GitHub автоматически

> **Антивирус**: некоторые AV ругаются на свежесобранный exe + xray. Добавьте папку в исключения.
