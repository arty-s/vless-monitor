...
- **Современный интерфейс Fluent 2** — в стиле Windows 11 Settings, со скруглёнными карточками и системным accent-цветом
...
- **Окно детальных статусов** — каждая проверка с понятным комментарием («Всё работает, замедлений нет»), значения обновляются на месте без мерцания
